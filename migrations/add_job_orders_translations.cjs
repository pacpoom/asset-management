...
const translations = [
  // ── Group 1: Missing $t() keys for job-orders LIST page ──
  ...
  ['to', 'to', 'ถึง'],
  ['of', 'of', 'จาก'],
  ['No Job Orders found or search did not match any data', 'No Job Orders found', 'ไม่พบรายการ Job Order หรือข้อมูลไม่ตรงกับเงื่อนไขการค้นหา'],
  ...
  // ── Group 2: Static bilingual container-alert labels ──
  ...
  // ── Group 3: ff.* semantic label keys ──
  ['ff.overdue_label', 'Overdue', 'เกิน'],
  ['ff.day', 'd', ' วัน'],          // leading space for Thai: "5 วัน"
  ['ff.day_compact', 'd', 'วัน'],   // no leading space for compact chips
  ...
  // ── Group 4: Detail page & checkout modal labels ──
