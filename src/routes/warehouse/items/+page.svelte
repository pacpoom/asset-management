...
<div class="mb-6 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
	...
	<div class="flex items-center gap-2">
		<form method="POST" action="/items/export">
...
<!-- Search Bar -->
<div class="mb-4">
	<form method="GET" action="/items" class="relative">
		...
		<div class="relative flex max-h-[90vh] w-full max-w-2xl transform flex-col rounded-xl bg-white shadow-2xl transition-all">
			...
			>
				...
				<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
					<!-- Item Code -->
					<div>
						<label for="item_code" class="mb-1 block text-sm font-medium">{$t('Item Code *')}</label>
						<input
							type="text"
							name="item_code"
							id="item_code"
