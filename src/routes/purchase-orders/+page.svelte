...
<div class="mb-6 flex items-center justify-between">
	<div>
		<h1 class="text-2xl font-bold text-gray-800">{$t('Purchase Orders')}</h1>
		<p class="mt-1 text-sm text-gray-500">{$t('Manage purchase orders from vendors')}</p>
	</div>
	<a
...
>
	<div class="relative md:col-span-1">
		...
		<input
			...
			placeholder={$t('Search PO Placeholder')}
							...
							<div class="flex justify-center gap-2">
								...
								{:else}
									<span
										...
										title={$t('Change status before printing')}
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 20 20"
	...
	>
		...
		>
			...
			<p class="text-sm text-gray-500">
				{$t('Are you sure you want to delete purchase order')} <strong>{deletePoNumber}</strong>?
				<br />
