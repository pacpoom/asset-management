...
<div class="mb-6 rounded-lg border bg-white shadow-sm overflow-hidden">
	<div class="flex justify-between items-center border-b p-4 bg-gray-50">
		<h2 class="text-lg font-semibold text-gray-700">เอกสารแนบ (Attachments)</h2>
	</div>
	<div class="p-6">
			...
			{#each attachments as file}
				<div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-blue-400 hover:shadow-md">
					...
					<div class="flex flex-shrink-0 items-center gap-2 ml-4">
                        <a href={file.url} target="_blank" rel="noopener noreferrer" class="rounded-full bg-gray-50 p-2 text-gray-500 hover:bg-gray-100 hover:text-blue-600 transition-colors" title="ดูไฟล์">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
								<path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
								<path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
							</svg>
						</a>
						<a href={file.url} download={file.file_original_name} class="rounded-full bg-blue-50 p-2 text-blue-600 hover:bg-blue-100 transition-colors" title="ดาวน์โหลด">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
