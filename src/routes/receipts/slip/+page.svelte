<script lang="ts">
	...
	let vatRate = 7; // ค่า Default 7%
	let whtRate = 0; // ค่า Default 0%

	// Reactive Statements (คำนวณอัตโนมัติเมื่อค่าเปลี่ยน)
	...
	$: itemsJson = JSON.stringify(items); // แปลงรายการเป็น JSON เพื่อส่งไป Server

	// ฟังก์ชันจัดการรายการสินค้า
	function addItem() {
		items = [
			...items,
			{
	...
	// เมื่อเลือกสินค้า ให้ดึงชื่อและราคามาใส่อัตโนมัติ
